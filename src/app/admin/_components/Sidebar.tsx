        ...
        <div className="flex p-2 border-r-2 border-black mr-[2rem]">
            <ul className="flex flex-col space-y-2">
                ...
                <li className="text-xl flex flex-col font-semibold p-2">
                    ...
                    <span onClick={() => router.push("/admin/cinema/create")} className={`pl-4 pt-2 hover:text-red-600 hover:cursor-pointer ${ cinemaPage ? "text-red-600": "text-black"}`}>Create Cinema</span>
                </li>
                <li className="text-xl flex flex-col font-semibold p-2">
                    ...
                    <span onClick={() => router.push("/admin/movies/create")} className={`pl-4 hover:text-red-600 hover:cursor-pointer pt-2 ${ moviesPage ? "text-red-600": "text-black"}`}>Create movies</span>
                </li>
